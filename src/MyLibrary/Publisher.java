...
public class Publisher extends javax.swing.JFrame {
        ...
        public void connect()
    {
        ...
        public void publisher_load()
        {
            int c;
        try {
            pst=con.prepareStatement("select * from publisher");//Category is the table name in database
            rs=pst.executeQuery();
            ...
            Vector v2=new Vector();
                ...
                v2.add(rs.getString("Publisher_Name")); // these will be names of the columns of database table
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            //action of Add button-sending Author data to sql
            
        String name = txtname.getText();
        String address = txtaddress.getText();
        String phone= txtphone.getText();
        try {
            pst = con.prepareStatement("insert into publisher(Publisher_Name,Address,Phone_Number)values(?,?,?)"); //1st one is table name of sql and inside bracket these are column names
            ...
            if(k==1)
            {
            JOptionPane.showMessageDialog(this, "Publisher details created successfully..");
            txtname.setText("");//to clear the Author name box
            ...
            publisher_load();//will show the current input on jtable
            }
            else
            {
            JOptionPane.showMessageDialog(this, "Error in Publisher details creation!!");
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String phone= txtphone.getText();
        try {
            pst = con.prepareStatement("update publisher set Publisher_Name = ?, Address= ?, Phone_Number= ? where ID = ?"); //1st one is database table name,rest are column name
            pst.setString(1, name);
            pst.setString(2,address);
            pst.setString(3,phone);
            pst.setInt(4, id);
            ...
            if(k==1)
            {
            JOptionPane.showMessageDialog(this, "Publisher details Updated successfully..");
            txtname.setText("");//to clear the category box
            txtaddress.setText("");//to clear the status box
            txtphone.setText("");
            txtname.requestFocus();//to bring the cursor on category box
            publisher_load();//load the updated data on the jtable
            jButton1.setEnabled(true);//reenable the Add button
            }
            else
            {
            JOptionPane.showMessageDialog(this, "Error in Publisher details Updatation!!");
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst = con.prepareStatement("delete from publisher where id = ?"); //here author is database table name
            pst.setInt(1, id);
            int k = pst.executeUpdate();
            if(k==1)
            {
            JOptionPane.showMessageDialog(this, "Publisher details Removed successfully..");
            ...
            {
            JOptionPane.showMessageDialog(this, "Error in Publisher details Removal!!");
            }
