...
public class Author extends javax.swing.JFrame {
        ...
        public void connect()
    {
        ...
        public void author_load()
        {
            int c;
        try {
            pst=con.prepareStatement("select * from author");//Category is the table name in database
            rs=pst.executeQuery();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = con.prepareStatement("insert into author(Author_Name,Address,Phone_Number)values(?,?,?)"); //1st one is table name of sql and inside bracket these are column names
            ...
            if(k==1)
            {
            JOptionPane.showMessageDialog(this, "Author details created successfully..");
            ...
            author_load();//will show the current input on jtable
            }
            else
            {
            JOptionPane.showMessageDialog(this, "Error in Author details creation!!");
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String phone= txtphone.getText();
        try {
            pst = con.prepareStatement("update author set Author_Name = ?, Address= ?, Phone_Number= ? where ID = ?"); //1st one is database table name,rest are column name
            pst.setString(1, name);
            pst.setString(2,address);
            pst.setString(3,phone);
            pst.setInt(4, id);
            ...
            author_load();//load the updated data on the jtable
            jButton1.setEnabled(true);//reenable the Add button
            }
            else
            {
            JOptionPane.showMessageDialog(this, "Error in Author details Updatation!!");
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst = con.prepareStatement("delete from author where id = ?"); //here author is database table name
            pst.setInt(1, id);
            int k = pst.executeUpdate();
            if(k==1)
            {
            JOptionPane.showMessageDialog(this, "Author details Removed successfully..");
            ...
            {
            JOptionPane.showMessageDialog(this, "Error in Author details Removal!!");
            }
